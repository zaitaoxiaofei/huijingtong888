...
CREATE TABLE IF NOT EXISTS analytics_shop_daily (
  ...
  effective_orders INT NOT NULL DEFAULT 0,
  ...
  accrued_profit DECIMAL(18,4) NOT NULL DEFAULT 0,
  accrued_order_count INT NOT NULL DEFAULT 0,
  pending_profit DECIMAL(18,4) NOT NULL DEFAULT 0,
  ...
  return_loss DECIMAL(18,4) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS ozon_stock_snapshots (
  ...
  free_stock_count DECIMAL(18,4) NOT NULL DEFAULT 0,
  paid_stock_count DECIMAL(18,4) NOT NULL DEFAULT 0,
  expiring_stock_count DECIMAL(18,4) NOT NULL DEFAULT 0,
  waitingdocs_stock_count DECIMAL(18,4) NOT NULL DEFAULT 0,
  paid_storage_start_at DATE NULL,
  stock_days DECIMAL(18,4) NULL,
  average_daily_sales DECIMAL(18,4) NULL,
  stock_level VARCHAR(64) NOT NULL DEFAULT '',
  raw_json LONGTEXT NULL,
  synced_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
