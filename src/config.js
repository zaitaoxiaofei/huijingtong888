...
export const config = {
  ...
  backgroundOzonFinanceSyncIntervalMinutes: readNumberEnv("BACKGROUND_OZON_FINANCE_SYNC_INTERVAL_MINUTES", 360),
  backgroundOzonFinanceSyncInitialDelaySeconds: readNumberEnv("BACKGROUND_OZON_FINANCE_SYNC_INITIAL_DELAY_SECONDS", 900),
  backgroundOzonFinanceSyncDays: readNumberEnv("BACKGROUND_OZON_FINANCE_SYNC_DAYS", 14),
