...
export const config = {
  ...
  siteAccessSessionHours: readNumberEnv("SITE_ACCESS_SESSION_HOURS", 168),
  ...
  backgroundOrderSyncIntervalMinutes: readNumberEnv("BACKGROUND_ORDER_SYNC_INTERVAL_MINUTES", 30),
  ...
  backgroundAdvertisingTodaySyncTimeoutMinutes: readNumberEnv("BACKGROUND_ADVERTISING_TODAY_SYNC_TIMEOUT_MINUTES", 5),
