...
<template>
  <section class="work-card">
    ...
    <div v-if="isMainPlan" class="plan-actions">
      <el-button @click="addPlan('高端原厂风')">高端原厂风</el-button>
      <el-button @click="addPlan('白底清晰风')">白底清晰风</el-button>
      <el-button @click="addPlan('安装场景风')">安装场景风</el-button>
      <el-button type="primary" :icon="Plus" @click="addPlan('自定义Prompt')">添加方案</el-button>
    </div>
    ...
    <div v-else class="target-actions">
      ...
      <el-button type="primary" :icon="Plus" @click="addManual">添加车型</el-button>
      <el-button @click="pasteDialog = true">批量粘贴</el-button>
      <el-button @click="templateDialog = true">常用模板</el-button>
      <el-button @click="importDialog = true">从选品表导入</el-button>
    </div>
    ...
    <el-dialog v-model="pasteDialog" title="批量粘贴车型" width="560px" align-center>
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="applyPaste">加入列表</el-button>
      </template>
    </el-dialog>
    ...
    <el-dialog v-model="templateDialog" title="常用车型模板" width="720px" align-center>
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="applyTemplates">一键加入</el-button>
      </template>
    </el-dialog>
    ...
    <el-dialog v-model="importDialog" title="从选品表导入车型" width="880px" align-center>
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="applyImport">导入车型</el-button>
      </template>
    </el-dialog>
  </section>
</template>
